// RUN: INPUT=300; \
// RUN: %test-patmos-input-librt --print-stats __patmos_main_mem_access_compensation 2>&1 | \
...
extern void __patmos_main_mem_access_compensation(unsigned max, unsigned remaining);        
...
{	
	...
	__patmos_main_mem_access_compensation(max, remaining);
