// RUN: INPUT=100; \
// RUN: %test-patmos-input-librt --print-stats __patmos_main_mem_access_compensation_di 2>&1 | \
...
extern void __patmos_main_mem_access_compensation_di(unsigned max, unsigned remaining);        
...
{	
	...
	__patmos_main_mem_access_compensation_di(max, remaining);
