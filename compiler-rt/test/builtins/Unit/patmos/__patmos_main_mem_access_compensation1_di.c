// RUN: INPUT=100; \
// RUN: %test-patmos-input-librt --print-stats __patmos_main_mem_access_compensation1_di 2>&1 | \
...
extern void __patmos_main_mem_access_compensation1_di();   
#define COMPENSATION_FN_ALIAS __patmos_main_mem_access_compensation1_di
