...
// RUN: %exec-patmos --print-stats __patmos_main_mem_access_compensation4 2>&1 | \
...
extern void __patmos_main_mem_access_compensation4();   
#define COMPENSATION_FN_ALIAS __patmos_main_mem_access_compensation4
