; RUN: %test_execution_main 0=87 1=88 2=89 3=90 4=91 5=92
; RUN: %test_execution_indirect 0=87 1=88 2=89 3=90 4=91 5=92
; END.
;//////////////////////////////////////////////////////////////////////////////////////////////////
; 
...
define i32 @with_loop(i32 %iteration_count)  {
entry:
  br label %for.cond
