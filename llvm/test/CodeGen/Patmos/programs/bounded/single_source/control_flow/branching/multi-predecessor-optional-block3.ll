; RUN: %test_execution_main 0=4 9=13 10=12 14=16 15=13 17=15
; RUN: %test_execution_indirect 0=4 9=13 10=12 14=16 15=13 17=15
; END.
;//////////////////////////////////////////////////////////////////////////////////////////////////
;
; Tests can have a block with multiple predecessors that might be skipped altogether.
;
; This variation tests the liveliness of predicates between blocks. Therefore, we clobber all predicates
; in the middle block (as seen in single-path code) to see if the predicate of succeeding blocks
; gets maintained.
;
;//////////////////////////////////////////////////////////////////////////////////////////////////
