; This is the default smoke version of nested_loop_const_var.ll. It keeps the
; same constant outer loop and variable inner loop, but uses only boundary
; inputs. Run nested_loop_const_var.ll with expensive_checks enabled for the
; full input sweep.
; RUN: %test_execution_main 0=5 4=25
; RUN: %test_execution_indirect 0=5 4=25
; END.
;//////////////////////////////////////////////////////////////////////////////////////////////////
;
