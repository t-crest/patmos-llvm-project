...
public:
  ...
  ///
  PatmosSubtarget(const Triple &TT, StringRef CPU, StringRef FS, const PatmosTargetMachine &TM, CodeGenOptLevel L);
  ...
  bool hasPostRAScheduler(CodeGenOptLevel OptLevel) const;

  /// Return true if the MI Pre-RA Scheduler should be used.
  bool usePreRAMIScheduler(CodeGenOptLevel OptLevel) const;

  /// Return true if the Patmos scheduler should be used instead of the default
  /// post-RA scheduler.
  bool usePatmosPostRAScheduler(CodeGenOptLevel OptLevel) const;
