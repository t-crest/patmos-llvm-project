#ifndef TARGET_PATMOS_SINGLEPATH_MEMORYACCESSANALYSISIMPL_H_
#define TARGET_PATMOS_SINGLEPATH_MEMORYACCESSANALYSISIMPL_H_
...
#endif /* TARGET_PATMOS_SINGLEPATH_MEMORYACCESSANALYSISIMPL_H_ */
